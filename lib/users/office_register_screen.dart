  ...
  void _handleRegister() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Office account created successfully! Please login.'),
            backgroundColor: Colors.green,
          ),
        );

        // Login ekranına geri dönüş
      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Register as office staff to access\nadministration and management tools.',
              style: TextStyle(
