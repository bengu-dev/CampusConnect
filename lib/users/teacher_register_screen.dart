      ...
      body: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Kampüs faaliyetlerinizi yönetmek için\nhesabınızı oluşturun.',
            ...
            CustomTextField(
              ...
              hint: 'ör. FAK-2024-001',
              icon: Icons.badge_rounded,
              controller: _staffIdController,
              accentColor: _accent,
              validator: (v) {
                if (v == null || v.trim().isEmpty) return 'Personel numarası zorunlu';
            ...
            CustomTextField(
              label: 'Bölüm',
              hint: 'ör. Bilgisayar Mühendisliği',
              icon: Icons.domain_rounded,
              controller: _departmentController,
              accentColor: _accent,
              validator: (v) {
                if (v == null || v.trim().isEmpty) return 'Bölüm zorunlu';
                return null;
              },
            ),
            const SizedBox(height: 20),
            ...
            CustomTextField(
              label: 'E-posta',
              hint: 'ogretim@universite.edu.tr',
